...
import { deleteStudy } from "@studies/lib/actions";

export const CreateButton = () => {
  return (
    <Link
      href="/dashboard/studies/services/create"
...
export const EditButton = ({ id }: { id: number }) => {
  return (
    <Link
      href={`/dashboard/studies/services/edit/${id}`}
...
export const DeleteButton = ({ id }: { id: number }) => {
  const DeleteStudyWithId = deleteStudy.bind(null, id);
  return (
    <form action={DeleteStudyWithId}>
